...
Support C++ names with namespaces as typename in array definition in config file.

Add new builtin NodeTags found in master branch.

### Fix

Empty NodeTag was added during tag auto search.
